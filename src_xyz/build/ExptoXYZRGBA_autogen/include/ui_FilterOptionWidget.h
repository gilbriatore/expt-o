...
public:
    ...
    {
        FilterOptionWidget->setWindowTitle(QApplication::translate("FilterOptionWidget", "Form", Q_NULLPTR));
        chkEnableFiltering->setText(QApplication::translate("FilterOptionWidget", "Ativar", Q_NULLPTR));
        lblLeafSize->setText(QApplication::translate("FilterOptionWidget", "Tamanho da folha", Q_NULLPTR));
        lblLeafSize_2->setText(QApplication::translate("FilterOptionWidget", "m", Q_NULLPTR));
    } // retranslateUi
