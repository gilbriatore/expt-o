...
public:
    ...
    {
        ClusteringWidget->setWindowTitle(QApplication::translate("ClusteringWidget", "Form", Q_NULLPTR));
        toolBox->setItemText(toolBox->indexOf(wgtFilterOptionView), QApplication::translate("ClusteringWidget", "Filtragem", Q_NULLPTR));
        toolBox->setItemText(toolBox->indexOf(wgtMinCutOptionView), QApplication::translate("ClusteringWidget", "Segmenta\303\247\303\243o Min Cut", Q_NULLPTR));
        toolBox->setItemText(toolBox->indexOf(wgtSegOptionView), QApplication::translate("ClusteringWidget", "Segmentaca\303\247\303\243o SAC", Q_NULLPTR));
        toolBox->setItemText(toolBox->indexOf(wgtClusterOptionView), QApplication::translate("ClusteringWidget", "Agrupamento", Q_NULLPTR));
        label->setText(QApplication::translate("ClusteringWidget", "Tempo processamento (ms)", Q_NULLPTR));
        lblSegInputFile->setText(QApplication::translate("ClusteringWidget", "Arquivo", Q_NULLPTR));
        btnSegment->setText(QApplication::translate("ClusteringWidget", "Segmentar", Q_NULLPTR));
    } // retranslateUi
