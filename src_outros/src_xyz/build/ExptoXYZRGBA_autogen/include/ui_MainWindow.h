...
public:
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Expt-o 3D", Q_NULLPTR));
        actionExit->setText(QApplication::translate("MainWindow", "Sair", Q_NULLPTR));
        actionError->setText(QApplication::translate("MainWindow", "Error", Q_NULLPTR));
        ...
        actionUse_simulation->setText(QApplication::translate("MainWindow", "Use simulation", Q_NULLPTR));
        actionDepthImgDefault_mode->setText(QApplication::translate("MainWindow", "Default mode", Q_NULLPTR));
        actionDepthImgSXGA_15Hz->setText(QApplication::translate("MainWindow", "SXGA 15Hz", Q_NULLPTR));
        actionDepthImgVGA_30Hz->setText(QApplication::translate("MainWindow", "VGA 30Hz", Q_NULLPTR));
        actionDepthImgVGA_25Hz->setText(QApplication::translate("MainWindow", "VGA 25Hz", Q_NULLPTR));
        actionDepthImgQVGA_25_Hz->setText(QApplication::translate("MainWindow", "QVGA 25Hz", Q_NULLPTR));
        actionDepthImgQVGA_30Hz->setText(QApplication::translate("MainWindow", "QVGA 30Hz", Q_NULLPTR));
        actionDepthImgQQVGA_60Hz->setText(QApplication::translate("MainWindow", "QQVGA 60Hz", Q_NULLPTR));
        actionDepthImgQQVGA_30Hz->setText(QApplication::translate("MainWindow", "QQVGA 30Hz", Q_NULLPTR));
        actionImageDefault_mode->setText(QApplication::translate("MainWindow", "Default mode", Q_NULLPTR));
        actionImageSXGA_15Hz->setText(QApplication::translate("MainWindow", "SXGA 15Hz", Q_NULLPTR));
        actionImageVGA_30Hz->setText(QApplication::translate("MainWindow", "VGA 30Hz", Q_NULLPTR));
        actionImageVGA_25Hz->setText(QApplication::translate("MainWindow", "VGA 25Hz", Q_NULLPTR));
        actionImageQVGA_25Hz->setText(QApplication::translate("MainWindow", "QVGA 25Hz", Q_NULLPTR));
        actionImageQVGA_30Hz->setText(QApplication::translate("MainWindow", "QVGA 30Hz", Q_NULLPTR));
        actionImageQVGA_60Hz->setText(QApplication::translate("MainWindow", "QVGA 60Hz", Q_NULLPTR));
        actionImageQQVGA_25Hz->setText(QApplication::translate("MainWindow", "QQVGA 25Hz", Q_NULLPTR));
        actionImageQQVGA_30Hz->setText(QApplication::translate("MainWindow", "QQVGA 30Hz", Q_NULLPTR));
        actionImageQQVGA_60Hz->setText(QApplication::translate("MainWindow", "QQVGA 60Hz", Q_NULLPTR));
        actionDepthImgQVGA_60Hz->setText(QApplication::translate("MainWindow", "QVGA 60Hz", Q_NULLPTR));
        actionDepthImgQQVGA_25Hz->setText(QApplication::translate("MainWindow", "QQVGA 25Hz", Q_NULLPTR));
        maintab->setTabText(maintab->indexOf(tracking), QApplication::translate("MainWindow", "Rastreamento", Q_NULLPTR));
        maintab->setTabText(maintab->indexOf(clustering), QApplication::translate("MainWindow", "Segmenta\303\247\303\243o", Q_NULLPTR));
        maintab->setTabText(maintab->indexOf(recognition), QApplication::translate("MainWindow", "Reconhecimento", Q_NULLPTR));
        menu3D_Camera->setTitle(QApplication::translate("MainWindow", "Principal", Q_NULLPTR));
        menuCamera_settings->setTitle(QApplication::translate("MainWindow", "Configura\303\247\303\243o", Q_NULLPTR));
        menuDepthImgMode->setTitle(QApplication::translate("MainWindow", "Depth image mode", Q_NULLPTR));
        menuImage_mode->setTitle(QApplication::translate("MainWindow", "Image mode", Q_NULLPTR));
    } // retranslateUi
